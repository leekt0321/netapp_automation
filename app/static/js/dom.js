...
export const sidebarRailToggleButtonEl = document.getElementById("sidebar-rail-toggle-button");
export const appLiveRegionEl = document.getElementById("app-live-region");
export const serverOfflineOverlayEl = document.getElementById("server-offline-overlay");
export const serverOfflineTitleEl = document.getElementById("server-offline-title");
export const serverOfflineMessageEl = document.getElementById("server-offline-message");
export const serverOfflineMetaEl = document.getElementById("server-offline-meta");
export const serverReconnectButtonEl = document.getElementById("server-reconnect-button");
...
export const membersStatusEl = document.getElementById("members-status");
...
export const integrityCleanupButtonEl = document.getElementById("integrity-cleanup-button");
export const integrityReportListEl = document.getElementById("integrity-report-list");
...
export const refreshDataButtonEl = document.getElementById("refresh-data-button");
export const refreshDataStatusEl = document.getElementById("refresh-data-status");
export const refreshDataLabelEl = document.getElementById("refresh-data-label");
export const refreshDataPercentEl = document.getElementById("refresh-data-percent");
export const refreshProgressBarEl = document.getElementById("refresh-progress-bar");
export const contentShellEl = document.querySelector(".content-shell");
...
export const confirmModalEl = document.getElementById("confirm-modal");
export const confirmFormEl = document.getElementById("confirm-form");
export const confirmTitleEl = document.getElementById("confirm-title");
export const confirmDescriptionEl = document.getElementById("confirm-description");
export const confirmInputLabelEl = document.getElementById("confirm-input-label");
export const confirmInputTextEl = document.getElementById("confirm-input-text");
export const confirmInputEl = document.getElementById("confirm-input");
export const confirmSubmitEl = document.getElementById("confirm-submit");
export const confirmCancelEl = document.getElementById("confirm-cancel");
export const confirmStatusEl = document.getElementById("confirm-status");
export const requestFormEl = document.getElementById("request-form");
export const requestEditorModalEl = document.getElementById("request-editor-modal");
export const requestEditorPanelEl = document.querySelector("#request-editor-modal .board-editor-panel");
...
export const requestDetailEl = document.getElementById("request-detail");
...
export const bugEditorModalEl = document.getElementById("bug-editor-modal");
export const bugEditorPanelEl = document.querySelector("#bug-editor-modal .board-editor-panel");
...
export const bugDetailEl = document.getElementById("bug-detail");
...
export function createStorageViews(storageKeys) {
  ...
  for (const storageKey of storageKeys) {
    storageViews[storageKey] = {
      ...
      siteSearchEl: getStorageElement(storageKey, "site-search"),
      siteSortEl: getStorageElement(storageKey, "site-sort"),
      siteCountEl: getStorageElement(storageKey, "site-count"),
      siteSwitchListEl: getStorageElement(storageKey, "site-switch-list"),
